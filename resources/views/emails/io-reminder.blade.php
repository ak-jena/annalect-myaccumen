...
<table cellspacing="0" cellpadding="10" style="color:#666;font:13px Arial;line-height:1.4em;width:100%;">
	<tbody>
            ...
            <tr>
                <td>
                    <p> Please upload the IO Links required for {{ $campaign->brief->client->name }}, {{ $campaign->brief->campaign_name }}.</p>
                    <p>Do note that any delay in supplying the IO may cause a delay in the campaign going live.</p>
                    <p>
