...
<table cellspacing="0" cellpadding="10" style="color:#666;font:13px Arial;line-height:1.4em;width:100%;">
	<tbody>
            ...
            <tr>
                <td>
                    <p> {{ $campaign->latestLog->user->name }} has rejected the booking for {{ $campaign->brief->client->name }}, {{ $campaign->brief->campaign_name }}.</p>
                    <p>Access the link below to amend.</p>
                    <p>
