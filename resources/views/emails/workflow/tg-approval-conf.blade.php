...
<table cellspacing="0" cellpadding="10" style="color:#666;font:13px Arial;line-height:1.4em;width:100%;">
	<tbody>
            ...
            <tr>
                <td>
                    <p>{{ $campaign->latestLog->user->name }} has approved the Targeting Grid for  {{ $campaign->brief->client->name }}, {{ $campaign->brief->campaign_name }}. An email has gone to the relevant Agency user for approval.
                    <p>Regards,<br>
                    Programmatic Team
                    </p>                
                </td>
