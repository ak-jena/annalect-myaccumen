...
<table cellspacing="0" cellpadding="10" style="color:#666;font:13px Arial;line-height:1.4em;width:100%;">
	<tbody>
            ...
            <tr>
                <td>
                    <p> {{ $campaign->latestLog->user->name }} has cancelled the campaign for {{ $campaign->brief->client->name }}, {{ $campaign->brief->campaign_name }}.</p>
                    <p>Access the comments on the link below for why the campaign was cancelled.</p>
                    <p>
                        <a href="{{ route('comments', ['brief_id' => $campaign->brief->id])}}">
                            {{ route('comments', ['brief_id' => $campaign->brief->id])}}
                        </a>
                    </p>
