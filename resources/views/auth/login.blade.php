...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>ACCUEN</b> | LOGIN</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Please sign in to start your session</p>

    <form action="{{App::make('url')->to('login')}}" method="post">
        {!! csrf_field() !!}
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="remember" value="remember" id="checkbox1"> Remember Me
            </label>
          </div>
        </div>
        <!-- /.col -->
