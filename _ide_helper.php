 ...
 * Generated for Laravel 5.1.41 (LTS) on 2016-08-12.
 *
...
namespace {
    ...
    class Jira extends \Univerze\Jira\Facade\JiraFacade{
        ...
        public static function search($jql = null){
            return \Univerze\Jira\Jira::search($jql);
        }
        ...
        public static function create($data){
            return \Univerze\Jira\Jira::create($data);
        }
         ...
         * @static 
         */
        public static function update($issue, $data){
            return \Univerze\Jira\Jira::update($issue, $data);
        }
        
    }


    class Baselib extends \App\BaseLib{
